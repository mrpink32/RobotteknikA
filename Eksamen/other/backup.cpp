...
void handle_max_pos(char *command, uint8_t client_num)
{
    ...
    case 0:
    {
        ...
        int32_t data = motor1.position_pid.set_max_ctrl_value(result);
        sprintf(MsgBuf, "%s:%d, %d,", get_command_name(CMD_MAX_POS), id, data);
        break;
    }
    case 1:
    {
        // int32_t data = motor1.set_max_position(result);
        int32_t data = motor2.position_pid.set_max_ctrl_value(result);
        sprintf(MsgBuf, "%s:%d, %d,", get_command_name(CMD_MAX_POS), id, data);
        break;
    }
    case 2:
    {
        // int32_t data = motor1.set_max_position(result);
        int32_t data = motor3.position_pid.set_max_ctrl_value(result);
        sprintf(MsgBuf, "%s:%d, %d,", get_command_name(CMD_MAX_POS), id, data);
        break;
    }
    case 3:
...
void handle_max_vel(char *command, uint8_t client_num)
{
    ...
    case 0:
    {
        ...
        int32_t data = motor1.velocity_pid.set_max_ctrl_value(result);
        sprintf(MsgBuf, "%s:%d, %d,", get_command_name(CMD_MAX_VEL), id, data);
        break;
    }
    case 1:
    {
        // int32_t data = motor1.set_max_velocity(result);
        int32_t data = motor2.velocity_pid.set_max_ctrl_value(result);
        sprintf(MsgBuf, "%s:%d, %d,", get_command_name(CMD_MAX_VEL), id, data);
        break;
    }
    case 2:
    {
        // int32_t data = motor1.set_max_velocity(result);
        int32_t data = motor3.velocity_pid.set_max_ctrl_value(result);
        sprintf(MsgBuf, "%s:%d, %d,", get_command_name(CMD_MAX_VEL), id, data);
        break;
    }
    case 3:
