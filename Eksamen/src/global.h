...
// Motor 3:
const int32_t PIN_PID_LOOP_3 = 17; // debug monitoring pid loop
// const int32_t PIN_LIMIT_SW = 25;    // limit switch pin
const int32_t PIN_ENC_A_3 = 26;       // encoder A ch
const int32_t PIN_ENC_B_3 = 27;       // encoder B ch
const int32_t PIN_HBRIDGE_INA_3 = 18; // hbridge INA pin
const int32_t PIN_HBRIDGE_INB_3 = 19; // hbridge INB pin
const int32_t PIN_HBRIDGE_PWM_3 = 23; // hbridhe PWM pin
